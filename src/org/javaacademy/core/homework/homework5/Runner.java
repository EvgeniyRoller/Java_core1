...
public class Runner {
    ...
    private static final int MINIMUM_FIELDS_COUNT = 2;
        ...
        private static void ex1() {
            ...
            try (Scanner scanner = new Scanner(org.javaacademy.core.homework.homework5.Runner.class.getClassLoader().getResourceAsStream(fileName));) {
                scanner.nextLine();
                String text = scanner.nextLine();
                String[] fields = text.split(";");
                if (fields.length >= MINIMUM_FIELDS_COUNT
                        && isNumber(fields[MONEY_FIELD_INDEX])) {
